...
#' | `make169` | Logical, gives 16:9 dimension to presentation (my favorite). Optional, defaults to FALSE. |
...
#'
beamer <- function(...){
  templ <- system.file("rmarkdown", "templates", "beamer", "resources", "template.tex", package = "SSCItemplates")
...
templ_beamer <- function(){
  print(system.file("rmarkdown", "templates", "beamer", "resources", "template.tex", package = "SSCItemplates"))
}
